...
public class DCTechView {
    ...
    @Given("Search for {int} to {int} employee in DC view of OrgChart")
    public void search_for_to_employee_in_dfv_c_view_of_org_chart(Integer start, Integer end) {
        ...
        for (int i = start; i < end; i++) {
            ...
            List<String> userHierarchy = GenericUtils.getDCHierarchy(i);
            DriverAction.hoverOver(CommonLocators.ecEmployeeBox("Prashank Chaudhary", "GSI N 015"));
            DriverAction.scrollToBottom();
            DriverAction.getElement(CommonLocators.ecTeamDownKey("Prashank Chaudhary", "GSI N 015")).click();
            ...
            GenericUtils.waitUntilLoaderDisappear();
            GenericUtils.waitUntilElementAppear(CommonLocators.chartContainer);
            LoginSrepDefinition.switchToView("DC");
        }
    }
}
