...
#    And Switch to "Gemini" view
  ...
  Scenario: Open employee branch in Gemini View and verify if correct information is displayed or not 1000-1109
    Given Search for 1000 to 1109 employee in OrgChart
